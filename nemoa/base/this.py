...
import inspect
from nemoa.base import check, tree
...
def get_submodule(name: str, ref: OptModule = None) -> OptModule:
    ...
    return tree.get_module(ref.__name__ + '.' + name)
...
def call_attr(name: str, *args: Any, **kwds: Any) -> Any:
    ...
    """
    return tree.call_attr(get_caller_module(), name, *args, **kwds)
