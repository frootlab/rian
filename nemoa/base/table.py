...
class Cursor(Container):
    ...
    mode: property = VirtAttr(fget='_get_mode', readonly=True)
    rowcount: property = VirtAttr(fget='_get_rowcount', readonly=True)
...
class Table(Container):
    ...
    fields: property = VirtAttr(fget='_get_fields', readonly=True)
