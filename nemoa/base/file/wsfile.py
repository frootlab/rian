...
class WsFile(Container):
    ...
    name: property = VirtAttr(fget='_get_name', readonly=True)
    name.__doc__ = """Filename of the workspace without file extension."""

    files: property = VirtAttr(fget='search', readonly=True)
    ...
    changed: property = VirtAttr(fget='_get_changed', readonly=True)
