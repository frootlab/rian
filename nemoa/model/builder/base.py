...
class AutoEncoder:
    ...
    def build(self):
        ...
        if not entity.has_base(self.settings['dataset'], 'Dataset'):
            return {}
...
class Model:
    ...
    def build(self):
        ...
        if entity.has_base(self.settings['dataset'], 'Dataset'):
        ...
        if entity.has_base(self.settings['network'], 'Network'):
        ...
        if entity.has_base(self.settings['system'], 'System'):
